...
var getBox = function getBox(elm) {
  var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
      ...
      margin = _ref$margin === undefined ? false : _ref$margin;

  var box = elm.getBoundingClientRect();
  var styles = getComputedStyle(elm);

  return {
    top: box.top - window.scrollY - (margin ? parseInt(styles.marginTop, 10) : 0),
    left: box.left - window.scrollX - (margin ? parseInt(styles.marginLeft, 10) : 0),
    width: box.width + (margin ? parseInt(styles.marginLeft, 10) + parseInt(styles.marginRight, 10) : 0),
    height: box.height + (margin ? parseInt(styles.marginTop, 10) + parseInt(styles.marginBottom, 10) : 0)
  };
};
...
var Morph = function (_Component) {
  ...
  function Morph() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref5 = Morph.__proto__ || Object.getPrototypeOf(Morph)).call.apply(_ref5, [this].concat(args))), _this), _this.state = {
      ...
      var originalRect = getBox(original, { margin: true });
