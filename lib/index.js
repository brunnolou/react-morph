...
var getBox = function getBox(elm) {
  ...
  return {
    ...
    width: box.width + window.scrollX + parseInt(styles.marginLeft, 10) + parseInt(styles.marginRight, 10),
    height: box.height + parseInt(styles.marginTop, 10) + parseInt(styles.marginBottom, 10)
  };
};
...
var Morph = function (_Component) {
  ...
  function Morph() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref4 = Morph.__proto__ || Object.getPrototypeOf(Morph)).call.apply(_ref4, [this].concat(args))), _this), _this.state = {
      state: 'from'
  ...
  _createClass(Morph, [{
    ...
    value: function componentWillUnmount() {
      ...
      this.elementsCloned.forEach(function (elm) {
        _this2.props.portalElement.removeChild(elm);
      });
    }
