...
exports.applyOverlayStyle = function (node, styles) {
    ...
    Object.assign(node.style, __assign({ position: 'absolute', 'transform-origin': 'top left' }, styles));
};
...
exports.interpolateObject = function (from, to, _a) {
    if (from === void 0) { from = {}; }
    if (to === void 0) { to = {}; }
    var _b = _a.easings, easings = _b === void 0 ? easing_1.linear : _b, isReversed = _a.isReversed;
    return function (t) { return (__assign({}, Object.keys(from).reduce(function (acc, key) {
        var _a;
        var shouldRev = isReversed ? easing_1.reversed : function (x) { return x; };
        var easeFn = shouldRev(typeof easings === 'function' ? easings : easings[key] || easing_1.linear);
