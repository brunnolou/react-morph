...
var halfClampEnd = util_1.clamp(1 - fadeDistance, 1);
var halfClampStart = util_1.clamp(0, fadeDistance);
var easeFast = function (x) {
    return easeInOut(Number(popcorn_1.interpolate([1 - fadeDistance, 1], [0, 1])(halfClampEnd(x))));
};
var easeSlow = function (x) {
    return easeInOut(Number(popcorn_1.interpolate([0, fadeDistance], [0, 1])(halfClampStart(x))));
};
